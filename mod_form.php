...
/**
 * The main mod_icecreamgame configuration form.
 *
 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_icecreamgame_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('icecreamgamename', 'mod_icecreamgame'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'icecreamgamename', 'mod_icecreamgame');
